...
<div class="checklist-container">
    <form id="form-orcamento" method="POST">
        ...
        <div class="checklist-header">
            CHECK-LIST &nbsp;&nbsp; <span style="font-size: 16px;">DATA: <input type="date" name="data_orcamento"
                    style="border:none;background:transparent;font-weight:bold;color:#dc3545;"></span>
        </div>
        ...
        <div class="row form-row">
            <div class="col-md-6 position-relative">
                <label>NOME:</label>
                <input type="text" class="form-control form-control-checklist" id="cliente_nome" name="cliente_nome"
                    placeholder="Busque ou digite..." required autocomplete="off">
            ...
            <div class="col-md-3">
                <label>CEL:</label>
                <input type="text" class="form-control form-control-checklist" id="cliente_cel" name="cliente_cel"
        ...
        <div class="row form-row">
            <div class="col-md-3">
                <label>CEP:</label>
                <input type="text" class="form-control form-control-checklist" id="cep" name="cep"
        ...
        <div class="row form-row">
            <div class="col-md-4 position-relative">
                <label>CARRO:</label>
                <input type="text" class="form-control form-control-checklist" id="veiculo_busca" name="veiculo_busca"
            ...
            <div class="col-md-2">
                <label>PLACA:</label>
                <input type="text" class="form-control form-control-checklist" id="veiculo_placa" name="veiculo_placa"
        ...
        <div class="row form-row">
            ...
            <div class="col-md-3">
                <label>HR:</label>
                <input type="text" class="form-control form-control-checklist" id="veiculo_hr" name="veiculo_hr"
                    placeholder="( )">
            </div>
        </div>
        ...
        <div class="row form-row">
            <div class="col-md-4"><label>MONTAGEM:</label><input type="text" class="form-control form-control-checklist"
                    name="montagem"></div>
            <div class="col-md-4"><label>BICO:</label><input type="text" class="form-control form-control-checklist"
                    name="bico"></div>
            <div class="col-md-4"><label>VL=:</label><input type="text"
                    class="form-control form-control-checklist moeda" name="vl_bico" placeholder="R$ 0,00"></div>
        </div>

        <!-- PNEUS -->
        <div class="row form-row">
            <div class="col-md-4"><label>PNEUS - MARCA:</label><input type="text"
                    class="form-control form-control-checklist" name="pneus_marca"></div>
            <div class="col-md-4"><label>QUANT:</label><input type="text" class="form-control form-control-checklist"
                    name="pneus_quant"></div>
            <div class="col-md-4"><label>VL=:</label><input type="text"
                    class="form-control form-control-checklist moeda" name="pneus_vl" placeholder="R$ 0,00"></div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-checklist">
                <thead>
                    <tr>
                        ...
                        <?php foreach ($fornecedores as $fornecedor): ?>
                            <th style="width:<?php echo $largura_fornecedor; ?>%;">
                                <?php echo htmlspecialchars($fornecedor['nome']); ?></th>
                        <?php endforeach; ?>
                ...
                <tbody id="itens-orcamento">
                    <?php for ($i = 0; $i < 20; $i++): ?>
                        <tr>
                            <td><input type="text" name="mec[<?php echo $i; ?>]" placeholder="Peça/Serviço"
                                    class="busca-peca" data-index="<?php echo $i; ?>"></td>
                            <td>
                            ...
                            <?php foreach ($fornecedores as $fornecedor): ?>
                                <td><input type="text" name="fornecedor[<?php echo $fornecedor['id']; ?>][<?php echo $i; ?>]"
                                        class="moeda-input" placeholder="0,00"></td>
                            <?php endforeach; ?>
        ...
        <div class="row form-row" style="margin-top:15px;">
            <div class="col-md-4"><label>OL/MOTOR:</label><input type="text" class="form-control form-control-checklist"
                    name="ol_motor" placeholder="__W"></div>
            <div class="col-md-3"><label>QUAN:</label><input type="text" class="form-control form-control-checklist"
                    name="ol_motor_quan" placeholder="__ / __"></div>
            <div class="col-md-3"><label>FIL ( ):</label><input type="text" class="form-control form-control-checklist"
                    name="filtro"></div>
        </div>
        <div class="row form-row">
            <div class="col-md-3"><label>F.COMB: ( )</label><input type="text"
                    class="form-control form-control-checklist" name="f_comb"></div>
            <div class="col-md-3"><label>F.AR: ( )</label><input type="text" class="form-control form-control-checklist"
                    name="f_ar"></div>
            <div class="col-md-3"><label>F.AR.COND: ( )</label><input type="text"
                    class="form-control form-control-checklist" name="f_ar_cond"></div>
        </div>
        <div class="row form-row">
            <div class="col-md-4"><label>OL/C:</label><input type="text" class="form-control form-control-checklist"
                    name="ol_c"></div>
            <div class="col-md-3"><label>QUANT:</label><input type="text" class="form-control form-control-checklist"
                    name="ol_c_quan"></div>
            <div class="col-md-3"><label>OL/H:</label><input type="text" class="form-control form-control-checklist"
                    name="ol_h"></div>
            <div class="col-md-2"><label>QUANT:</label><input type="text" class="form-control form-control-checklist"
                    name="ol_h_quan"></div>
        </div>

        <!-- VALORES -->
        <div class="row form-row" style="margin-top:20px; border-top:2px solid #dc3545; padding-top:15px;">
            <div class="col-md-4"><label>VALOR PARCIAL:</label><input type="text"
                    class="form-control form-control-checklist moeda" id="valor_parcial" name="valor_parcial"
                    placeholder="R$ 0,00" readonly></div>
            <div class="col-md-4"><label>PARCELADO:</label><input type="text"
                    class="form-control form-control-checklist" id="parcelado" name="parcelado"></div>
        </div>
        <div class="row form-row">
            <div class="col-md-4">
                <label style="font-size:14px;font-weight:bold;">VALOR TOTAL:</label>
                <input type="text" class="form-control form-control-checklist moeda" id="valor_total" name="valor_total"
                    placeholder="R$ 0,00" readonly style="font-weight:bold;font-size:14px;">
            </div>
            <div class="col-md-4"><label>PARCELADO:</label><input type="text"
                    class="form-control form-control-checklist" name="parcelado_total"></div>
