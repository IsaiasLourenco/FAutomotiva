...
function avancarData($data, $nome_frequencia, $dias) {
    ...
    if (strpos($nome_frequencia, 'mensal') !== false) {
        ...
        $timestamp = strtotime('+2 months', $timestamp);
    } elseif (strpos($nome_frequencia, 'trimestral') !== false) {
        $timestamp = strtotime('+3 months', $timestamp);
    } elseif (strpos($nome_frequencia, 'quinzenal') !== false) {
        $timestamp = strtotime('+15 days', $timestamp);
    } elseif (strpos($nome_frequencia, 'semanal') !== false) {
        $timestamp = strtotime('+7 days', $timestamp);
    } elseif (strpos($nome_frequencia, 'diário') !== false || strpos($nome_frequencia, 'diario') !== false) {
