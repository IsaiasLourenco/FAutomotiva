...
// ✅ Nome único para o arquivo (armazenado em caminho_arquivo)
...
// ✅ Salva no banco (USANDO SUAS COLUNAS REAIS)
...
$stmt->execute([
    ':id_conta' => $id_conta,
    ':nome_orig' => $arquivo['name'],        // → nome_arquivo (nome original)
    ':tipo' => $ext,                          // → tipo_arquivo (extensão)
    ':caminho' => $nome_unico,                // → caminho_arquivo (nome único no servidor)
