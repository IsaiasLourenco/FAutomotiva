                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nome-perfil" name="nome" required maxlength="100" placeholder="Ex: Bosch">
                        </div>
                        <div class="col-md-3">
                            <label for="nota_qualidade">Nota (0-10) *</label>
                            <input type="number" class="form-control" id="nota_qualidade" name="nota_qualidade" required min="0" max="10" value="5">
                        </div>
                        <div class="col-md-3">
