...
include __DIR__ . '/rel_recibo_pagamento.php';
$html = ob_get_clean();
...
header("Content-Disposition: inline; filename=recibo_pagamento_" . date('Ymd_His') . ".pdf");

$pdf->stream("recibo_pagamento_" . date('Ymd_His') . ".pdf", [
    "Attachment" => false
]);
exit;
?>